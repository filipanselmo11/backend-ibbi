...
@router.post('/create', response_model=ProductRequest, status_code=201, dependencies=[Depends(token_verifier)])
...
@router.get('/products', response_model=list[ProductResponse], status_code=200, dependencies=[Depends(token_verifier)])
...
@router.get('/products/{product_id}', response_model=ProductResponse, status_code=200, dependencies=[Depends(token_verifier)])
