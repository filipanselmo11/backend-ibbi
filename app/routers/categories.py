...
@router.post('/create', response_model=CategoryResponse, status_code=201, dependencies=[Depends(token_verifier)])
...
@router.get('/categories', response_model=list[CategoryResponse], status_code=200, dependencies=[Depends(token_verifier)])
...
@router.get('/categories/{category_id}', response_model=CategoryResponse, status_code=200, dependencies=[Depends(token_verifier)])
